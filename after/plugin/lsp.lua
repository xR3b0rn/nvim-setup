  ...
  wk.add({
    {
      ...
      { "]d",          vim.diagnostic.goto_prev,     desc = "goto prev diagnostics" },
      { "<leader>vca", vim.lsp.buf.code_action,      desc = "apply code action" },
    ...
    },
    {
      ...
      { "<C-k>'", function() require('lsp_signature').toggle_float_win() end, desc = 'toggle signature' },
    }
  })
